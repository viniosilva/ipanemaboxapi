...
const docTemplate = `{
    ...
    "paths": {
        "/auth/login": {
            "post": {
                "description": "*Validation errors:*\n- email: emailEmpty, emailInvalid\n- password: passwordEmpty, userNotFound",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/auth/update-password": {
            "put": {
                ...
                "description": "*Validation errors:*\n- old_password: passwordEmpty, invalidPassword\n- new_password: passwordEmpty, passwordTooLong, passwordWeak",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/presentation.UpdateUserPasswordRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "middleware.ServerErrorResponse": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string",
        ...
        "pkg.ValidationError": {
            ...
            "properties": {
                "error": {
                    "$ref": "#/definitions/pkg.ValidationErrorDetails"
                },
                "message": {
                    "type": "string",
        ...
        "presentation.UpdateUserPasswordRequest": {
            "type": "object",
            "properties": {
                "new_password": {
                    "type": "string",
